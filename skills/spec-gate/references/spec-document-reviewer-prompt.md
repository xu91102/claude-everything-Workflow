...
Only block on defects that can produce the wrong implementation or an unsafe plan. Keep wording and style suggestions advisory.
...
Blocking issues:
- [section]: [specific defect] — [planning impact]
